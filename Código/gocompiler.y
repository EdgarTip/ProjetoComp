...
Expr: Expr OR Expr                                             {$$= create_node(OPERATOR, "Or", num_line, num_column, NULL); addChild($$,$1); addChild($$,$3); }
    ...
    |   Expr LT Expr                                           {$$= create_node(OPERATOR, "Lt", num_line, num_column, NULL); addChild($$,$1); addChild($$,$3); }
    |   Expr GT Expr                                           {$$= create_node(OPERATOR, "Gt", num_line, num_column, NULL); addChild($$,$1); addChild($$,$3); }
    |   Expr EQ Expr                                           {$$= create_node(OPERATOR, "Eq", num_line, num_column, NULL); addChild($$,$1); addChild($$,$3); }
    |   Expr NE Expr                                           {$$= create_node(OPERATOR, "Ne", num_line, num_column, NULL); addChild($$,$1); addChild($$,$3);}
    |   Expr LE Expr                                           {$$= create_node(OPERATOR, "Le", num_line, num_column, NULL); addChild($$,$1); addChild($$,$3);}
    |   Expr GE Expr                                           {$$= create_node(OPERATOR, "Ge", num_line, num_column, NULL); addChild($$,$1); addChild($$,$3);}
